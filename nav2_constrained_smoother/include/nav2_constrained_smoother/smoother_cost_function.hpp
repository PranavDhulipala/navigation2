...
public:
  ...
  SmootherCostFunction(
    ...
    const std::shared_ptr<ceres::BiCubicInterpolator<ceres::Grid2D<uint8_t>>> & costmap_interpolator,
...
protected:
  ...
  std::shared_ptr<ceres::BiCubicInterpolator<ceres::Grid2D<uint8_t>>> costmap_interpolator_;
};
